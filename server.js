...
var server = http.createServer(function(request, response){
  ...
  if(path === '/index.html'){
    ...
    const string2 = fs.readFileSync('./public/main.js')
    ...
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/css;charset=utf-8')
    const string4 = fs.readFileSync('./public/2.js')
    response.write(string4)
    response.end()
  }else if(path === '/3.html'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/html;charset=utf-8')
    const string5 = fs.readFileSync('./public/3.html')
    ...
    const string6 = fs.readFileSync('./public/5.json')
    ...
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/json;charset=utf-8')
    const string7 = fs.readFileSync('./db/page2.json')
    response.write(string7)
    response.end()
  }
  else if(path === '/page3.json'){
    response.statusCode = 200
    response.setHeader('Content-Type', 'text/json;charset=utf-8')
    const string8 = fs.readFileSync('./db/page3.json')
    response.write(string8)
    response.end()
  }
  else {
